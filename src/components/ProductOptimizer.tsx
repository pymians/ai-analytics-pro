...
import { Wand2, Image, Palette, Target, TrendingUp, Zap, Eye, BarChart3 } from 'lucide-react';
...
export const ProductOptimizer: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-white">{t('content.product_optimizer_title')}</h2>
        <p className="text-gray-300 mt-1">{t('content.product_optimizer_description')}</p>
      </div>
      ...
      <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { id: 'photo', label: 'Fotoğraf Analizi', icon: Image, color: 'purple' },
